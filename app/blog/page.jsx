                ...
                <div className="container mx-auto px-4 py-6">
                    <div className="flex justify-between items-center">
                        ...
                        <nav className="text-sm text-gray-200">
                            ...
                            <Link href="/blog" className="mx-2 hover:text-white transition duration-300">BLOG</Link> /
                            <Link href="/reel" className="mx-2 hover:text-white transition duration-300">REEL</Link>
                        </nav>
                    </div>
                </div>
            </header>
